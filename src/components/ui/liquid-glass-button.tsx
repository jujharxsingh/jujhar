...
const buttonVariants = cva(
  "inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gold disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-burgundy text-white hover:bg-burgundy/90",
        destructive: "bg-red-600 text-white hover:bg-red-600/90",
        cool: "bg-gradient-to-t border border-b-2 border-zinc-950/40 from-burgundy to-burgundy/85 shadow-md shadow-burgundy/20 ring-1 ring-inset ring-white/25 transition-[filter] duration-200 hover:brightness-110 active:brightness-90 text-white",
        outline: "border border-espresso/15 bg-white hover:bg-ivory text-espresso",
        secondary: "bg-ivory text-espresso hover:bg-ivory/80",
...
const liquidbuttonVariants = cva(
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-[color,box-shadow,transform] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-gold/50 focus-visible:ring-[3px]",
  {
    variants: {
      variant: {
        default: "bg-transparent hover:scale-105 duration-300 transition text-espresso",
...
> = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#000] to-[#A0A0A0]",
    inner: "bg-gradient-to-b from-burgundy via-gold to-ivory",
    button: "bg-gradient-to-b from-burgundy to-burgundy/40",
    textColor: "text-white",
